...
const ResetPassword = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const requestPasswordReset = axios.put("http://localhost:3000/account/password-reset",{
            token: token,
            password:password
        })
        requestPasswordReset.then((result) => {
            navigate("/login")
        }).catch(error => {
            if( error.response ){
    ...
    return ( 
        <div className="mainContainer">
            ...
            <div className="inputContainer">
                ...
                <br/>
                <br/>
                <input value={confirmPassword} placeholder="Enter your password here"
            ...
            <div className={"inputContainer"}>
                <input className={"inputButton"} type="button" onClick={handleSubmit} value={"Submit"} />
            </div>
        </div>
     );
}
