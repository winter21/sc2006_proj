...
const Home = (props) => {
    ...
    (session) =>
      ...
      (selectedInterests.length === 0 ||
        selectedInterests.every((interest) =>
          session.interest.includes(interest)
        ))
  );
  ...
  const interests = [
    ...new Set(sessions.flatMap((session) => session.interest)),
        ...
        >
          {interests.map((interest) => (
            <Chip
              ...
              variant={
                selectedInterests.includes(interest) ? "outlined" : "default"
              }
              style={{
                margin: "0 5px",
                cursor: "pointer",
                ...
                backgroundColor: selectedInterests.includes(interest)
                  ? "transparent"
                  : interestColors[interest] || "default",
              ...
              <ListItem button onClick={() => handleCardClick(session._id)}>
                ...
                >
                  <CardContent>
                    ...
                    <Typography variant="body1">
                      Slots: {session.slots - session.participants.length}/
                      {session.slots} slot(s) available
                    </Typography>
                  </CardContent>
                </Card>
              </ListItem>
